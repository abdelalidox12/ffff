                    ...
                    <div id="wrapper">
                      ...
                      <section id="booking-confirmation">
                        <div class="booking-confirmation-text">
                          <h1>{{($produit['Nom_hotel'])}}</h1>
                        </div>
                      </section>
                    <div id="room-image">
                      <img id="room-image" src="{{asset($produit['image1'])}}" alt="Room Image">
                    </div>
...
<div class="booking-form-w3layouts">
  ...
  <form action="{{Route('storeh')}}" method="post">
    ...
    <div class="main-flex-w3ls-sectns">
      <div class="field-agileinfo-spc form-w3-agile-text1">
        <input id="datepicker" name="Check_in" type="date" placeholder="Check-in Date" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="" class="hasDatepicker">
      </div>
      <div class="field-agileinfo-spc form-w3-agile-text2">

        <input type="time" id="timepicker" name="Time_in" class="timepicker form-control hasWickedpicker" placeholder="Check-in Time" value="" onkeypress="return false;">
      </div>
    </div>
    <div class="main-flex-w3ls-sectns">
      <div class="field-agileinfo-spc form-w3-agile-text1">
        <input id="datepicker" name="Check_out" type="date" placeholder="Departure Date" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="" class="hasDatepicker">
      </div>
      <div class="field-agileinfo-spc form-w3-agile-text2">
        <input type="time" id="timepicker" name="Time_out" class="timepicker form-control hasWickedpicker" placeholder="Departure Time" value="" onkeypress="return false;">
      </div>
    </div>
      ...
      <div class="field-agileinfo-spc form-w3-agile-text11">
        <select class="form-control">
                      <option value="">Adult(12+ Yrs)</option>
                       @if($produit['n_place']>0 )
                      <option value="1">1</option>
                      @if($produit['n_place']>1 )
                      <option value="2">2</option>
                      @if($produit['n_place']>2 )
                      <option value="3">3</option>
                      @if($produit['n_place']>3 )        
                      <option value="4">4</option>
                      @if($produit['n_place']>4 )
                      <option value="5">5+</option>@endif @endif @endif @endif @endif
                    </select>
      </div>
    ...
    <div class="clear"></div>
    <input type="text" name="idcho" value="{{$produit['id']}}" hidden>
    <input type="text" name="price" value="{{$produit['id']}}" hidden>
