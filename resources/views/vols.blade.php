 ...
 <div class="box-top" >
  <!-- <i class="fa-solid fa-badge-percent"></i> -->
      ...
      <div class="box-vol">
          ...
          @foreach ($vols as $profile)  @if($profile['id'] > 1)

       <div class="top-destinationv" >
       
              <img src="{{asset($profile['image1'])}}" alt="" class="produit-imgv">
              <div id="pinfv"> <h2 class="produit-titlev"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.947 511.947" style="enable-background:new 0 0 511.947 511.947;" xml:space="preserve">
                <g>
                    <g>
                        <path style="fill:#D7DBE0;" d="M509.492,139.794c-4.906-11.844-14.133-21.07-25.977-25.977s-24.891-4.906-36.734,0
                            ...
                            C512.765,156.387,512.765,147.692,509.492,139.794z"></path>
                    </g>
                    <g>
                        <path style="fill:#45BDF0;" d="M508.116,145.278L175.405,283.317c-10.859,4.5-22.273,6.68-33.578,6.68
                            ...
                            C509.858,144.342,509.044,144.894,508.116,145.278z"></path>
                    </g>
                    <g>
                        <path style="fill:#8A8895;" d="M358.056,262.949l-103.475,42.861l-16-39.017l103.39-42.826c8.197-3.395,17.591,0.527,20.94,8.743
                            l3.804,9.333C370.097,250.208,366.22,259.567,358.056,262.949z"></path>
                    </g>
                    <g>
                        <g>
                            <path style="fill:#5C546A;" d="M436.812,160.606c-2.078,0-4.156-0.875-5.594-2.398c-1.523-1.438-2.406-3.523-2.406-5.68
                                ...
                                c0,2.156-0.797,4.242-2.32,5.68C441.054,159.731,438.976,160.606,436.812,160.606z"></path>
                        </g>
                    </g>
                    <g>
                        <g>
                            <path style="fill:#5C546A;" d="M192.976,261.567c-2.164,0-4.242-0.797-5.68-2.32c-1.523-1.438-2.32-3.516-2.32-5.68
                                ...
                                c0,2.164-0.883,4.164-2.398,5.68C197.132,260.77,195.054,261.567,192.976,261.567z"></path>
                        </g>
                    </g>
                    <g>
                        <g>
                            <path style="fill:#5C546A;" d="M170.734,270.77c-2.078,0-4.156-0.883-5.602-2.32c-1.516-1.523-2.398-3.602-2.398-5.68
                                ...
                                c0,2.078-0.797,4.156-2.32,5.68C174.976,269.966,172.898,270.77,170.734,270.77z"></path>
                        </g>
                    </g>
                    <g>
                        <g>
                            <path style="fill:#5C546A;" d="M414.656,169.731c-2.078,0-4.164-0.805-5.68-2.32c-1.438-1.445-2.32-3.523-2.32-5.68
                                ...
                                c0,2.078-0.797,4.156-2.32,5.68C418.812,168.927,416.812,169.731,414.656,169.731z"></path>
                        </g>
                    </g>
                    <g>
                        <path style="fill:#B8BAC0;" d="M379.921,182.88c-2.172-3.055-6.172-4.203-9.586-2.758l-147.82,61.227
                            ...
                            C381.851,190.059,382.086,185.927,379.921,182.88z"></path>
                    </g>
                    <g>
                        <path style="fill:#5C546A;" d="M494.181,120.166l-25.229,10.448c-4.078,1.688-6.016,6.367-4.328,10.453
                            ...
                            C502.657,127.82,498.738,123.638,494.181,120.166z"></path>
                    </g>
                </g>
                <g>
                </g>
                ...
                </svg> {{$profile['Nom_vol']}}</h2>
              <p class="produi-descriptionv"><a >{{$profile['Ville_depart']}}</a>  <i id="to" class="fa-solid fa-arrow-right"></i> <a> {{$profile['Ville_arrivee']}}</a></p>
             <div> <span id="star"> @for($i=0;$i<5;$i++) <i class="fa-solid fa-star"></i> @endfor</span><br></div>
             <span class="pricev"><span> </span> <a href="{{ route('vol.show' , $profile->id)}}">Explore</a> <br>{{$profile['prix']}} DH</span></div>
